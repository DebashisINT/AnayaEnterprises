...
import com.anayaenterprises.features.NewQuotation.adapter.ViewAllQuotViewAdapter
import com.anayaenterprises.features.NewQuotation.api.GetQuotRegProvider
import com.anayaenterprises.features.NewQuotation.model.ViewDetailsQuotResponse
import com.anayaenterprises.features.NewQuotation.model.ViewQuotResponse
import com.anayaenterprises.features.NewQuotation.model.shop_wise_quotation_list
...
//                                    (mContext as DashboardActivity).showSnackMessage(getString(R.string.something_went_wrong))
    ...
    private fun saveDataAsPdf(addQuotEditResult: ViewDetailsQuotResponse) {
        ...
        val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString()+"/anayaenterprisesApp/QUTO/"
